    ...
    <footer className="border-t border-white/5 py-10">
      <div className="container mx-auto px-4 text-center space-y-4">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm text-muted-foreground font-inter">
          <a href="https://api.whatsapp.com/send/?phone=5511938012222" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">WhatsApp: (11) 93801-2222</a>
          <span className="text-white/20">·</span>
          <a href="mailto:contato@plan10.com.br" className="hover:text-accent transition-colors">contato@plan10.com.br</a>
          <span className="text-white/20">·</span>
          <a href="https://instagram.com/plan10seguros" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">@plan10seguros</a>
          <span className="text-white/20">·</span>
          <a href="https://www.facebook.com/plan10seguros" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">/plan10seguros</a>
        </div>
